...
CREATE TABLE `anggota_peneliti_mhs` (
  ...
  CONSTRAINT `relasi_penelitian_anggotamhs` FOREIGN KEY (`id_penelitian`) REFERENCES `penelitian` (`id_penelitian`) ON DELETE CASCADE,
  CONSTRAINT `relasi_penelitian_mhs` FOREIGN KEY (`nim`) REFERENCES `mahasiswa` (`nim`) ON DELETE CASCADE
...
CREATE TABLE `cek_barang` (
  ...
  `nama_cek` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id_cek`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
-- ----------------------------
INSERT INTO `cek_barang` VALUES ('0', 'belum dicek');
...
INSERT INTO `dosen` VALUES ('8740064', '428127401', 'Budhi', 'Irawan', 'BIR', 'Bandung', 'Laki-laki', '', 'https://budhiirawan.staff.telkomuniversity.ac.id/', '1', 'budhiirawan', '4f1dfda8eccefd294ae8bf5b1bd7e200', 'budhiirawan@telkomuniversity.ac.id', '1', null, '2', null, null, null);
...
INSERT INTO `dosen` VALUES ('13860021', '407048601', 'Surya', 'Micharandi Nasution', 'SMC', 'Medan', 'Laki-laki', '', 'https://michrandi.staff.telkomuniversity.ac.id/', '4', 'micharandi', '45fc11f4382c12fed16aa6ab97af5f6d', 'micharandi@telkomuniversity.ac.id', '1', null, '3', null, null, null);
INSERT INTO `dosen` VALUES ('14730053', '407117301', 'Tito', 'Waluyo Purboyo', 'TWP', 'Bogor', 'Laki-laki', '', null, '2', 'titowaluyo', '1c57b328955ca8050b47549365a4d6c7', 'titowaluyo@telkomuniversity.ac.id', '1', null, '3', null, null, null);
INSERT INTO `dosen` VALUES ('14780013', '19027809', 'Roswan', 'Latuconsina', 'RLC', '                            Jakarta                        ', 'Laki-laki', '0813205056', 'https://roswan.staff.telkomuniversity.ac.id/', '1', 'roswanlc', '684A8E4C1B12654304940AA79B660613', 'roswan@telkomuniversity.ac.id', '2', '18', '1', '', 'Pembina', 'IV/a');
...
INSERT INTO `dosen` VALUES ('15870030', '407058703', 'Randy', 'Erfa Saputra', 'RES', 'Jakarta', 'Laki-laki', '', 'https://resaputra.staff.telkomuniversity.ac.id/', '4', 'resaputra', '6579d2d31e015e97665e4309a15e18be', 'resaputra@telkomuniversity.ac.id', '2', null, '1', null, null, null);
...
INSERT INTO `mahasiswa` VALUES ('1103150004', 'Fajri', 'Rahmat Said', 'fajri@gmai.com', 'fajri', '437EB04136C59D226F14527F52726341', '80', '53');
...
INSERT INTO `roles` VALUES ('80', '7740390', null, null, '6');
INSERT INTO `roles` VALUES ('81', '7740391', null, null, '5');
INSERT INTO `roles` VALUES ('82', '10800047', null, null, '2');
...
CREATE TABLE `status` (
  ...
  `status_kk` varchar(100) DEFAULT NULL,
...
-- Records of t_judul
-- ----------------------------
INSERT INTO `t_judul` VALUES ('62', '1103150004', 'Fajri', 'Rahmat Said', 'fajri@gmai.com', 'PENERAPAN METODE EARNED VALUE MANAGEMENT PADA PROSES PENGENDALIAN PROYEK PT XYZ', 'Metode X', '93680020', '14780013', '14780013', 'soal_ngn.pdf', '1', '53', '4');
...
INSERT INTO `t_topik` VALUES ('4', 'PENERAPAN METODE EARNED VALUE MANAGEMENT PADA PROSES PENGENDALIAN PROYEK PT XYZ', '1', 'Java', '14780013', 'Lorem Ipsum', '4', null, '14860078');
